...
# OpenPifPaf -- tracking ShuffleNetV2-k30 with the TrackingPose (Tcaf)
# decoder. This is the paper's method: joints are grouped within a frame by
# Composite Association Fields and *across* neighbouring frames by a
# temporal composite field, so track IDs fall out of the same greedy
# decoder that produces the poses.
#
...
#     configs/body_2d_keypoint/openpifpaf/openpifpaf_tshufflenetv2k30-trackingpose_posetrack2018.py \
