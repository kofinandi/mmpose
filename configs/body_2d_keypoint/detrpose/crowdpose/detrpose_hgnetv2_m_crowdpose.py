...
# DETRPose-M (HGNetv2) evaluation on CrowdPose (14 keypoints).
# Paper: https://arxiv.org/abs/2506.13027
# Upstream: https://github.com/SebastianJanampa/DETRPose (inference_only)
#
# Evaluation-only. Expected README AP on CrowdPose test: ~72.0.
# Boxes are derived from keypoint min/max (upstream has no box head).
# Checkpoint:
#   https://github.com/SebastianJanampa/DETRPose/releases/download/model_weights/detrpose_hgnetv2_m_crowdpose.pth

train_cfg = None

model = dict(
    type='DETRPoseEstimator',
    model_name='detrpose_hgnetv2_m_crowdpose',
    checkpoint='data/models/detrpose_hgnetv2_m_crowdpose.pth',
