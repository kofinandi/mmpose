...
# DETRPose-L (HGNetv2) evaluation on CrowdPose (14 keypoints).
# Paper: https://arxiv.org/abs/2506.13027
# Upstream: https://github.com/SebastianJanampa/DETRPose (inference_only)
#
# Evaluation-only. Expected README AP on CrowdPose test: ~73.3.
# Boxes are derived from keypoint min/max (upstream has no box head).
# Checkpoint:
#   https://github.com/SebastianJanampa/DETRPose/releases/download/model_weights/detrpose_hgnetv2_l_crowdpose.pth

train_cfg = None

model = dict(
    type='DETRPoseEstimator',
    model_name='detrpose_hgnetv2_l_crowdpose',
    checkpoint='data/models/detrpose_hgnetv2_l_crowdpose.pth',
