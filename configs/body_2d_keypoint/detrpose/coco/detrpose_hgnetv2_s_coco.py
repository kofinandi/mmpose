...
# DETRPose-S (HGNetv2) evaluation on COCO keypoints.
# Paper: https://arxiv.org/abs/2506.13027
# Upstream: https://github.com/SebastianJanampa/DETRPose (inference_only)
#
# Evaluation-only config. Expected README AP on COCO val2017: ~67.0.
#
...
# Checkpoint:
#   https://github.com/SebastianJanampa/DETRPose/releases/download/model_weights/detrpose_hgnetv2_s.pth
...
model = dict(
    ...
    checkpoint='data/models/detrpose_hgnetv2_s.pth',
