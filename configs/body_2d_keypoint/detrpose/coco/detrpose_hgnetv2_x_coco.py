...
# DETRPose-X (HGNetv2) evaluation on COCO keypoints.
# Paper: https://arxiv.org/abs/2506.13027
# Upstream: https://github.com/SebastianJanampa/DETRPose (inference_only)
#
# Evaluation-only config. Expected README AP on COCO val2017: ~73.3.
#
...
# Checkpoint:
#   https://github.com/SebastianJanampa/DETRPose/releases/download/model_weights/detrpose_hgnetv2_x.pth

train_cfg = None

model = dict(
    type='DETRPoseEstimator',
    model_name='detrpose_hgnetv2_x',
    checkpoint='data/models/detrpose_hgnetv2_x.pth',
