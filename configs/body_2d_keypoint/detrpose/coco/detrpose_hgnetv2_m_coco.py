...
# DETRPose-M (HGNetv2) evaluation on COCO keypoints.
# Paper: https://arxiv.org/abs/2506.13027
# Upstream: https://github.com/SebastianJanampa/DETRPose (inference_only)
#
# Evaluation-only config. Expected README AP on COCO val2017: ~69.4.
#
...
# Checkpoint:
#   https://github.com/SebastianJanampa/DETRPose/releases/download/model_weights/detrpose_hgnetv2_m.pth

train_cfg = None

model = dict(
    type='DETRPoseEstimator',
    model_name='detrpose_hgnetv2_m',
    checkpoint='data/models/detrpose_hgnetv2_m.pth',
