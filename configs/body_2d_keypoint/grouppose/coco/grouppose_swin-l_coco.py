...
# GroupPose (Swin-L) evaluation on COCO keypoints.
# Paper: https://arxiv.org/abs/2308.07313
# Upstream: https://github.com/Michel-liu/GroupPose
#
# Evaluation-only. Expected README AP on COCO val2017: ~74.8.
...
# Checkpoint (Google Drive): data/models/grouppose_swinL.pth
...
model = dict(
    ...
    checkpoint='data/models/grouppose_swinL.pth',
