...
# Poseidon (ViT-H backbone, T=5 frame window), trained on PoseTrack21.
# https://github.com/CesareDavidePace/poseidon
#
# Matches the author-released `configs/bestposetrack21/configPoseidonVitH.yaml`:
...
#
# Checkpoint (author-released, `vith_model.pt`):
#   data/models/poseidon/vith_model.pt
#
# Run (topdown, GT boxes, matching the paper's evaluation protocol):
#   python tools/benchmark_e2e.py \
#     configs/body_2d_keypoint/poseidon/poseidon_vith-t5_posetrack21-288x384.py \
#     data/models/poseidon/vith_model.pt \
