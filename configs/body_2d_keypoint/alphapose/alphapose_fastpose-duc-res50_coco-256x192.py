...
# AlphaPose -- FastPose-DUC (ShuffleResNet-50 backbone), COCO-17, 256x192, with
...
#
# Mirrors the author config `configs/coco/resnet/256x192_res50_lr1e-3_1x-duc.yaml`
...
# MODEL.BACKBONE='shuffle', DUC stages 4/2/1 -- all from the upstream YAML.
#
...
#
# Checkpoints:
#   pose : data/models/alphapose/fast_421_res50-shuffle_256x192.pth
#          (author-released, "Fast Pose (DUC)" in external/AlphaPose/docs/MODEL_ZOO.md,
#           Google Drive id 1RlnL_YnnmgOM4L9L2szFdUnTjwptqtL-)
...
#     configs/body_2d_keypoint/alphapose/alphapose_fastpose-duc-res50_coco-256x192.py \
#     data/models/alphapose/fast_421_res50-shuffle_256x192.pth \
...
model = dict(
    ...
    alphapose_cfg='configs/coco/resnet/256x192_res50_lr1e-3_1x-duc.yaml',
    tracker=dict(
