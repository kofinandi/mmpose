...
# AlphaPose -- FastPose (SE-ResNet-50 + DUC head), COCO-17, 256x192, with
...
#
# Mirrors the author config `configs/coco/resnet/256x192_res50_lr1e-3_1x.yaml`
...
# 17 joints) and MODEL (FastPose, NUM_LAYERS=50) come from upstream.
#
...
#
# Checkpoints:
#   pose : data/models/alphapose/fast_res50_256x192.pth
#          (author-released, Google Drive id 1kQhnMRURFiy7NsdS8EFL-8vtqEXOgECn)
...
#     configs/body_2d_keypoint/alphapose/alphapose_fastpose-res50_coco-256x192.py \
#     data/models/alphapose/fast_res50_256x192.pth \
