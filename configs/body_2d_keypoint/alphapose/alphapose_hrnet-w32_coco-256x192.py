...
# AlphaPose -- HRNet-W32, COCO-17, 256x192, with
...
#
# Mirrors the author config `configs/coco/hrnet/256x192_w32_lr1e-3.yaml`
...
# MODEL.TYPE='PoseHighResolutionNet'; a different SPPE behind the same
# tracker, useful for separating pose quality from association quality.
#
...
#
# Checkpoints:
#   pose : data/models/alphapose/pose_hrnet_w32_256x192.pth
#          (author-released, "HRNet" in external/AlphaPose/docs/MODEL_ZOO.md,
#           Google Drive id 1i63BPlOnp2vSjIZ7ni4Yp3RCPQwqe922)
...
#     configs/body_2d_keypoint/alphapose/alphapose_hrnet-w32_coco-256x192.py \
#     data/models/alphapose/pose_hrnet_w32_256x192.pth \
...
model = dict(
    ...
    alphapose_cfg='configs/coco/hrnet/256x192_w32_lr1e-3.yaml',
    tracker=dict(
